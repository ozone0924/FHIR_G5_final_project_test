...
OUTBREAKS: list[dict] = [
    ...
    # ── 春季流感次波：flu_winter 結束後的反彈（完整落在 90 天視窗內） ─────
    {
        "id":          "flu_spring",
        "disease":     "Influenza",
        "label":       "春季流感次波（台中→全台）",
        "epicenter":   "台中市",
        "start_day":   -80,   # 約 80 天前（3/17）開始
        "peak_offset": 28,    # 高峰在 52 天前（4/15）
        "duration":    72,    # start+duration=-8（仍在退燒，近期有案例）
        "total_cases": 55,
        "spread_type": "respiratory",
        "county_delays": {
            "台中市": 0,  "彰化縣": 4,  "南投縣": 7,
            "台北市": 9,  "新北市": 8,  "桃園市": 8,
            "新竹市": 12, "苗栗縣": 10, "宜蘭縣": 11,
            "台南市": 13, "高雄市": 15,
            "花蓮縣": 17, "台東縣": 22,
        },
    },
