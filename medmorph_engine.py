...
def _random_tw_name(gender: str) -> str:
    ...
    male_names = [
        ...
        "韋廷", "峻瑋", "宇哲", "家銘", "冠志", "明宏", "柏凱", "育勝", "家慶", "建德", 
        "志榮", "俊諺", "承佑", "宇辰", "廷威", "柏豪", "冠勳", "育瑞", "志遠", "家宏", 
        "建良", "俊霖", "承宇", "彥宏", "宥宏", "柏宏", "冠毅", "育群", "志成", "家誠", 
        "建輝", "俊德", "承志", "宇傑", "廷宇", "柏誠", "冠倫", "育賢", "志宏", "建翔", 
        "俊廷", "承宏", "宇凱", "廷睿", "柏倫", "冠凱", "育睿", "浩宇", "俊熙", "子睿"
    ]
    # 女性常見名字組合 (100+)
    female_names = [
