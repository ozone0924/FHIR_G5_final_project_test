...
def _random_tw_name(gender: str) -> str:
    """產生隨機中文姓名，gender 可選 'male' 或 'female'"""
    surnames = [
        "陳", "林", "黃", "張", "李", "王", "吳", "劉", "蔡", "楊", 
        "許", "鄭", "謝", "洪", "郭", "邱", "曾", "廖", "賴", "徐"
    ]
    ...
    male_names = [
        ...
        "佳賢", "品睿", "奕勳", "冠穎", "聖傑", "建宇", "威廷", "承恩", "彥成", "宥翔", 
        "柏叡", "韋廷", "峻瑋", "宇哲", "家銘", "冠志", "明宏", "柏凱", "育勝", "家慶", 
        "建德", "志榮", "俊諺", "承佑", "宇辰", "廷威", "柏豪", "冠勳", "育瑞", "志遠", 
        "家宏", "建良", "俊霖", "承宇", "彥宏", "宥宏", "柏宏", "冠毅", "育群", "志成", 
        "家誠", "建輝", "俊德", "承志", "宇傑", "廷宇", "柏誠", "冠倫", "育賢", "志宏", 
        "家豪", "建翔", "俊廷", "承宏", "宇凱", "廷睿", "柏倫", "冠凱", "育睿", "志豪"
    ]
    # 女性常見名字組合 (100+)
    female_names = [
        ...
        "雅玲", "淑惠", "怡潔", "惠雯", "佳儀", "靜宜", "婉儀", "欣婷", "詩蓉", "采穎", 
        "嘉雯", "美君", "郁蕙", "冠婷", "佩宜", "宜慧", "雅珊", "淑華", "怡慧", "惠芳", 
        "佳靜", "靜儀", "婉珊", "欣潔", "詩儀", "采靜", "嘉宜", "美珠", "郁佳", "冠珊", 
        "佩儀", "宜靜", "雅雯", "淑靜", "怡靜", "惠雅", "佳郁", "靜君", "婉慧", "欣珊", 
        "詩君", "采郁", "嘉珊", "美蘭", "郁青", "冠雅", "佩雅", "宜君", "雅芳", "淑珊"
    ]
